...
export const Navbar = () => {
    ...
    const [profileToggleIsOpen, setprofileToggleIsOpen] = useState(true)
    ...
    return (<nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="flex items-center md:order-2 relative">
                <button type="button" onClick={() => setprofileToggleIsOpen(!profileToggleIsOpen)} className="flex mr-3 text-sm bg-black-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    <span className="sr-only">Open user menu</span>
                    <img className="w-8 h-8 rounded-full" src="https://surgassociates.com/wp-content/uploads/610-6104451_image-placeholder-png-user-profile-placeholder-image-png.jpg" alt="user photo" />
                </button>
                <div className={`z-50 top-[25px] right-[67px] md:top-[20px] md:right-[20px] ${profileToggleIsOpen ? "hidden" : "block"} absolute my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}>
            ...
            <div className={`${dropDownIsOpen ? "hidden" : "block"} absolute top-[60px] md:top-[0px] md:relative items-center justify-between w-full md:flex md:w-auto`}>
