...
export const ChatPage = () => {
    ...
    return (
        <div className="bg-gray-200 dark:bg-gray-800 flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
            <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-200 mt-16">
                <div className="relative flex items-center space-x-4">
                    <div className="relative">
                        <img src="https://images.unsplash.com/photo-1549078642-b2ba4bda0cdb?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="" className="w-10 sm:w-8 h-10 sm:h-8 rounded-full" />
                    </div>
                    <div className="flex flex-col leading-tight">
                        <div className="text-xl mt-1 flex items-center">
                            <span className="dark:text-gray-200 text-gray-700 mr-3">Anderson Vanhron</span>
                        </div>
                        <span className="dark:text-gray-200 text-sm text-gray-600">Junior Developer</span>
                    </div>
                </div>
            </div>
            <div id="messages" className="flex flex-col mb-20 space-y-6 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
            ...
            <div className=" border-gray-200 bg-gray-200 px-4 pt-4 mb-2 sm:mb-0 fixed bottom-0 left-0 right-0 border-t-2 border-gray-900 px-4 py-4 mb-2 sm:mb-0">
